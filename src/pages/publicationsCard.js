import img1 from "../images/Publication/publication_Topic-driven Ensemble for Online Advertising Generation.png";
import img2 from "../images/Publication/publication_Convolutional neural networks with hierarchical context transfe….png";
import img3 from "../images/Publication/publication_Spatiotemporal Filtering Pipeline for Efficient Social Networks Dat….png";
import img4 from "../images/Publication/publication_Hybrid Intellectual Scheme for Scheduling of Heterogeneous Wo….png";
import img5 from "../images/Publication/publication_Detection of housing and utility problems in districts through soc.png";
import img6 from "../images/Publication/publication_Decoupling graph convolutional networks for large-scale supervis….png";
import img7 from "../images/Publication/publication_Peregreen–modular database for efficient storage of historical tim….png";
import img8 from "../images/Publication/publication_Intelligent sightseeing in immensely manifold cities.png";
import img9 from "../images/Publication/publication_User Profiles Matching for Different Social Networks Based.png";
import img10 from "../images/Publication/publication_Orienteering Problem with Functional Profits for multi-sourc.png";
import img11 from "../images/Publication/publicaion_Intellectual Execution Scheme of Iterative Computational Models ….png";
import img12 from "../images/Publication/publication_Urban events prediction via convolutional neural networks a….png";
import img13 from "../images/Publication/publication_Ensemble-based method of answers retrieval for domain spe.png";
import img14 from "../images/Publication/publication_Evaluation of modern tools and techniques for storing time-serie.png";
import img15 from "../images/Publication/publication_Workflow scheduling using neural networks and reinforcement lear.png";
import img16 from "../images/Publication/publication_uilding City-Scale Walking Itineraries Using Large Geospatia.png";
import img17 from "../images/Publication/publication_Forecasting of the Urban Area State Using Convolutional Neural.png";
import img18 from "../images/Publication/publication_Multiscale event detection using convolutional quadtrees and ada.png";
import img19 from "../images/Publication/publication_Unified domain-specific language for collecting and processing dat.png";
import img20 from "../images/Publication/publication_The multi-level adaptive approach for efficient execution of multi-sc.png";
import img21 from "../images/Publication/publication_Precedent-Based Approach for the Identification of Deviant Behavio.png";
import img22 from "../images/Publication/publication_Blockchain-based transaction integrity in distributed big data.png";
import img23 from "../images/Publication/publication_Towards a scenario-based solution for extreme metocean event sim.png";
import img24 from "../images/Publication/publication_Storage tier-aware replicative data reorganization with prioritization.png";
import img25 from "../images/Publication/publication_Hybrid scheduling algorithm in early warning systems.png";
import img26 from "../images/Publication/publication_Distributed data-driven platform for urgent decision making in car.png";
import img27 from "../images/Publication/publication_Byzantine fault-tolerant and semantic-driven consensus proto.png";
import img28 from "../images/Publication/publication_Adaptive performance model for dynamic scaling Apache Spark St.png";
import img29 from "../images/Publication/publication_Hybrid evolutionary workflow scheduling algorithm for dynami.png";
import img30 from "../images/Publication/publication_Execution time estimation for workflow scheduling.png";

const publicationsCardList = [
  {
    images: img1,
  ...
  },
  {
    ...
    author: "Mikhail Melnik, Ivan Dolgov, Denis Nasonov",
    article:
      "Scheduling of workload in distributed computing systems is a well-known optimization proble. A workload may include single independent software packages. However, the computational process in scientific and industrial fields is often organized as compos…",
  },
  {
    images: img5,
    title:
      "Detection of housing and utility problems in districts through soc…",
    author: "Alexandr Zamiralov, Maria Khodorchenko, Denis Nasonov",
    article:
  ...
  },
  {
    ...
    author: "Mariia Koreneva, Alexander A Visheratin, Denis Nasonov",
    article:
  ...
  },
  {
    ...
    author: "Mikhail Melnik, Denis A Nasonov, Alexey Liniov",
    article:
  ...
  },
  {
    ...
    author: "Mikhail Melnik, Denis Nasonov",
    article:
  ...
  },
  {
    ...
    author: "Ksenia D Mukhina, Alexander A Visheratin, Denis Nasonov",
    article:
      "Nowadays, social networks play an important role in many aspects of people's life and in traveling in particular. People share their experience and opinions not only on specialized sites, like TripAdvisor, but also in social networks, e.g. Instagram. Combining information from different sources we can ge…",
  },
  {
    images: img17,
  ...
  },
  {
    ...
    author: "Denis Nasonov, Alexander A Visheratin, Alexander Boukhanovsky",
    article:
  ...
  },
  {
    ...
    author: "A Kalyuzhnaya, D Nasonov, S Ivanov, S Kosukhin, A Boukhanovsky",
    article:
  ...
  },
  {
    ...
    author: "A Visheratin, M Melnik, D Nasonov, N Butakov, A Boukhanovsky",
    article:
  ...
  },
  {
    ...
    author: "Stepan Rakitin, Alexander A Visheratin, Denis Nasonov",
    article:
  ...
  },
  {
    ...
    author: "Max Petrov, Nikolay Butakov, Denis Nasonov, Mikhail Melnik",
    article:
...
publicationsCardList.forEach((item) => renderCard(item));
